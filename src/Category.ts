...
export class CategoryDB {
    ...
    public async CreateCategory(id: { value: bigint }, cat: JobCategoryData): Promise<DBStatus> {
        if (!this._db) {
            return "Error";
        }
    ...
    public async FetchAllCategories(jobId: bigint, categories: JobCategoryData[]): Promise<DBStatus> {
        if (!this._db) {
            return "Error";
        }
